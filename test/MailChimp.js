  ...
  it("should return a lists", done => {
    let request = httpMocks.createRequest({
      ...
      headers: {
        provider: "mailChimp",
        authorization:
          "Basic ZGNhZWI0MTVlOGM3ZGYyZWU1NmUyMzc5NDJkYzdmZmE6OTRhOTY1MGM1NjZlMzZhYjhjZjQ0NjFmMzU4NGQ1YTYtdXMxOA=="
      }
    });
    ...
    chimp
      ...
      .then(body => {
        ...
        chai.expect(body.lists[0]).to.have.property("id");
        chai.expect(body.lists[0]).to.have.property("name");
...
describe("#getAllSegment()", () => {
  it("should return all segments", done => {
    ...
    chimp
      ...
      .then(body => {
        chai.expect(body).to.be.a("Object");
        chai.expect(body.segments[0]).to.have.property("id");
        chai.expect(body.segments[0]).to.have.property("name");
        done();
      })
      .catch(errorOnOperation => done(errorOnOperation));
  });
  ...
  it("should create new listId", done => {
    let request = httpMocks.createRequest({
      ...
      body: {
        ...
        permission_reminder:
          "You are receiving this email because you signed up for updates about Freddie's newest hats.",
        campaign_defaults: {
          from_name: "Freddie",
          from_email: "freddie@freddiehats.com",
          subject: "Ligtening Deals",
          language: "en"
        },
